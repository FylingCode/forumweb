...
<div class="container ques border border-success shadow-lg p-3 mb-5 bg-white rounded">
    ...
    <form action="contact.php" method="POST">
      <div class="form-group my-3">
        ...
        <input type="text" class="form-control" id="firstName" name="first_name" placeholder="Enter your first name" maxlength="30">
        <?php if ($first_name_err) echo "<small class='text-danger'>$first_name_err</small>"; ?>

      </div>
      <div class="form-group my-3">
        <label for="lastName">Your Last Name</label>
        <input type="text" class="form-control" id="lastName" name="last_name" placeholder="Enter your last name" maxlength="30">
        <?php if ($last_name_err) echo "<small class='text-danger'>$last_name_err</small>"; ?>

      </div>
      <div class="form-group my-3">
        <label for="email_address">Email address</label>
        <input type="email" class="form-control" id="email" name="email_address" placeholder="Enter your email" maxlength="30">
      ...
      <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone_number" name="phone_number" maxlength="12" value="<?php echo htmlspecialchars($phone_number); ?>" required>
            <?php if ($phone_err) echo "<small class='text-danger'>$phone_err</small>"; ?>
        </div>
      <div class="form-group my-3">
        <label for="query_des">Elaborate your Query</label>
        <textarea class="form-control" id="query_des" name="query_des" rows="3" placeholder="Enter your query here" maxlength="200"></textarea>
